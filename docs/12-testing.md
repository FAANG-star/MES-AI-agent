...
Tests: backend **399** · frontend **76** unit + **17** browser · SQL oracle **20/20 on all seven days**
...
```
make test         # 399 backend tests — includes the whole demo script, deterministically
